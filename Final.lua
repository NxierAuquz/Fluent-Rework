...
local Themes = {
	...
	Aqzxi = {
		Name = "Aqzxi",
		Accent = Color3.fromRGB(96, 153, 199),
		AcrylicMain = Color3.fromRGB(23, 28, 38),
		AcrylicBorder = Color3.fromRGB(90, 90, 90),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(0, 0, 0)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(36, 43, 50),
		Tab = Color3.fromRGB(41, 48, 53),
		Element = Color3.fromRGB(35, 41, 49),
		ElementBorder = Color3.fromRGB(35, 35, 35),
		InElementBorder = Color3.fromRGB(90, 90, 90),
		ElementTransparency = 0.87,
		ToggleSlider = Color3.fromRGB(255, 120, 120),
		ToggleToggled = Color3.fromRGB(42, 42, 42),
		SliderRail = Color3.fromRGB(255, 120, 120),
		DropdownFrame = Color3.fromRGB(160, 160, 160),
		DropdownHolder = Color3.fromRGB(23, 28, 38),
		DropdownBorder = Color3.fromRGB(35, 35, 35),
		DropdownOption = Color3.fromRGB(35, 41, 49),
		Keybind = Color3.fromRGB(120, 120, 120),
		Input = Color3.fromRGB(160, 160, 160),
		InputFocused = Color3.fromRGB(10, 10, 10),
		InputIndicator = Color3.fromRGB(150, 150, 150),
		Dialog = Color3.fromRGB(35, 41, 49),
		DialogHolder = Color3.fromRGB(23, 28, 38),
		DialogHolderLine = Color3.fromRGB(23, 28, 38),
		DialogButton = Color3.fromRGB(41, 48, 53),
